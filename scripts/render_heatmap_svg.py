...
OUT_PATH = sys.argv[1] if len(sys.argv) > 1 else os.path.join(HERE, "..", "contrib-heatmap.svg")
...
""".strip()
    ...
    parts.append(f'<text x="{canvas_w/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
                 f'text-anchor="middle">pranjal@github: ~/contributions --graph</text>')
    ...
    ly += 24
    parts.append(f'<text x="{PAD}" y="{ly}" font-size="13" fill="{MUTED}">current streak</text>')
    parts.append(f'<text x="{PAD + 117}" y="{ly}" font-size="13" fill="{ACCENT}" '
                 f'font-weight="700">{cs} days</text>')
    parts.append(f'<text x="{PAD + 183}" y="{ly}" font-size="13" fill="{MUTED}">&#183; longest</text>')
    parts.append(f'<text x="{PAD + 275}" y="{ly}" font-size="13" fill="{ACCENT}" '
                 f'font-weight="700">{ls} days</text>')
    parts.append(f'<text x="{canvas_w - PAD}" y="{ly}" font-size="12" fill="{MUTED}" text-anchor="end">'
